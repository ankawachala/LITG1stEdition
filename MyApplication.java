...
public class MyApplication {
	...
	JButton exitButton, saveButton, goBack1Button, goBack2Button, nextButton, previousButton, browseBillButton, uploadBillButton;
	...
	public MyApplication() throws IOException {
		...
		mp.designMenuPanel(db, tableModel);
		designEnterPanel();		
	...
	private void creatingShowTable() {
